...
import (
	...
	"rest-gorilla-route/internal/taskstore"
)
...
func main() {
	...
	router.HandleFunc("/task/{tag}/", server.tagHandler).Methods("GET")
	router.HandleFunc("/task/{year:[0-9]+}/{month:[0-9]+}/{day:[0-9]+}/", server.dueHandler).Methods("GET")
