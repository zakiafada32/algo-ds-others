// note: go algo have stdlib for heap -> https://pkg.go.dev/container/heap
package main
...
func (h *MaxHeap) maxHeapifyDown(index int) {
	...
	for l <= lastIndex {
		...
		// compare array value of current index to larger child and swaop if smaller
